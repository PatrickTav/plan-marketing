    ...
    <Container_section>
      ...
      <div className="card_container">
        <div className='card_content'>
          ...
          <p>
            A <span>PlanXP</span> tem uma equipe qualificada para o <span>
              desenvolvimento de jogos
              digitais
            </span> para <span>dispositivos móveis</span> (smartphones, tablets e afins).{' '}
          </p>
        </div>
        <div  className='card_content'>
          <img src={Photo2} alt="" />
          <p>
            ...
            da <span>gamificação</span> (aplicações que utilizam dinâmicas de jogos para
        ...
        <div  className='card_content'>
          <img src={Photo3} alt="" />
          <p>
            Utilizando as últimas tecnologias para a<span> criação de games</span>,
        ...
        <div className='plus'>
          ...
          <p>
            Experimente inovar com a <span>PlanXP</span> para <span>
